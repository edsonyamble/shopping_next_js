...
export const PUBLIC_URL = {
	...
	explorer: (query = '') => PUBLIC_URL.root(`/explorer${query}`),//всех товаров и поиска

	product: (id = '') => PUBLIC_URL.root(`/product/${id}`),//товара
	category: (id = '') => PUBLIC_URL.root(`/category/${id}`)//категории
}
//url user frontend
...
export const STORE_URL = {
	...
	settings: (storeId = '') => STORE_URL.root(`/${storeId}/settings`)//настроек магазина
}
//url frontend